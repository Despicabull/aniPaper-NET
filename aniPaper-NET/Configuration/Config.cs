...
namespace aniPaper_NET
{
    static class Config
    {
        ...
        public static string last_wallpaper = string.Empty;
        ...
        public static void LoadConfig()
        {
            ...
            if (ini_file.KeyExists("LastWallpaper", "General")) last_wallpaper = ini_file.Read("LastWallpaper", "General");
            else ini_file.Write("LastWallpaper", last_wallpaper, "General");
        ...
        public static void SaveConfig()
        {
            ...
            ini_file.Write("LastWallpaper", last_wallpaper, "General");
